 ...
 * generated in the calculadora.ws.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _Somar_QNAME = new QName("http://ws.calculadora/", "somar");
    private final static QName _SomarResponse_QNAME = new QName("http://ws.calculadora/", "somarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: calculadora.ws.client
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://ws.calculadora/", name = "somar")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.calculadora/", name = "somarResponse")
